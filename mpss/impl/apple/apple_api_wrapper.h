...
extern "C"
{
    ...
    bool MPSS_VerifySignature(const char *keyName, int signatureType, const std::uint8_t *hash, std::size_t hashSize,
                              const std::uint8_t *signature, std::size_t signatureSize);
    bool MPSS_VerifyStandaloneSignature(int signatureType, const std::uint8_t *hash, std::size_t hashSize,
