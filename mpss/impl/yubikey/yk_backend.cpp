                                                    ...
                                                    IsolationLevel minimum_isolation) const
{
    ...
    {
        mpss::utils::log_and_set_error("YubiKey hardware does not satisfy the requested minimum isolation.");
        return nullptr;
    }
    ...
    if (serials.empty())
    {
        mpss::utils::log_and_set_error("No YubiKey found.");
        return nullptr;
    }
